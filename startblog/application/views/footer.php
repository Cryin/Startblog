    ...
    <div class="col-sm-8 col-sm-offset-2">
      ...
      <h5 class="text-center" style="margin-bottom:50px">
        <p class="heart" style="color:black">
                        Made with in Startblog v1.5 <a href="<?php echo base_url('/feed')?>"><img src="<?php echo base_url('/static/img/rss.png')?>"> </a></li>
                    </p>
                    <p class="copyright" style="color:black">
                        ©2014- 2016 Cryin' | Images: <a href="https://github.com/Cryin/Startblog">Github</a></p>
