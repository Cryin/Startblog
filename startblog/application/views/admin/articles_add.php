  ...
  <div class="row">
      <div class="col-md-12">
         ...
         <div class="panel-body">
            <form action="<?php echo site_url('admin/Articles/update')?>" id="contentForm" method="post" accept-charset="utf-8">
                        <textarea name="content" cols="40" rows="50" id="textcontent" class="js-st-instance" ></textarea>
        ...
        <div id="attributes" class="modal fade" role="dialog">
          <div class="modal-dialog">
            ...
            <div class="form-group">
                    ...
                    <div class="controls">
                    <input type="text" name="title" id="title" class="form-control"  placeholder="<?php echo $this->lang->line('articles_title_tips'); ?>" required/>
                    </div> <!-- /controls -->
                </div> <!-- /form-group -->
               ...
               <div class="form-group">
                    ...
                    <div class="controls">
                         <textarea name="description" cols="40" rows="4" id="description" class="form-control" required ></textarea>
                 ...
                 <div class="form-group">
                    ...
                    <div class="controls">
                         <input type="text" name="tag" id="tag" class="form-control" placeholder="<?php echo $this->lang->line('articles_tags_tips'); ?>" />
