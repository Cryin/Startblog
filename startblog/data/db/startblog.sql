...
-- Records of siteinfo
-- ----------------------------
INSERT INTO `siteinfo` VALUES ('1', 'http://startblog.cc', '79564065@qq.com', 'Startblog  - 一款简洁、易用、跨平台自适应的Markdown博客系统', 'startblog,codeigniter blog,markdown博客程序,php blog,markdown blog,Markdown博客系统', 'startblog是一个基于codeigniter 3.x开发的简单，易用，Markdown博客系统！！！', '');
